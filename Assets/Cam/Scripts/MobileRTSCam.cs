...
namespace BE
{
    ...
    public class MobileRTSCam : MonoBehaviour
    {
        ...
        public Vector3 vEDCamRootRotStart;
        ...
        {
            instance = this;
            trCamera = GetComponent<Camera>().transform;//transform.Find ("Main Camera").transform;
        ...
        void Start()
        {
            x = gameObject.transform.eulerAngles.y;
            y = gameObject.transform.eulerAngles.x;
        }
        ...
        void Update()
        {
            ...
            if (Input.GetMouseButton(1))
            {
                ...
                x += Input.GetAxis("Mouse X") * 1.5f;
                y -= Input.GetAxis("Mouse Y") * 1.5f;

                y = ClampAngle(y, -90, 90);

                Quaternion rotation = Quaternion.Euler(y, x, 0);
                Vector3 position = rotation * new Vector3(0, 0, 0) + transform.position + new Vector3(0, 0, 0);
                ...
                //{
                //    vEDInRotation = true;
                //    vEDCamRootRotStart = vEDCamRootRot;
                //    Debug.Log(vEDCamRootRotStart);
                //    vEDMouseStart = vTouch;
                //    //Debug.Log ("editor rotation start");
                //}
                //else
                //{
                //    Debug.Log(Vector3.Distance(vTouch, vEDMouseStart));
                ...
                //        //vEDCamRootRot.z = 0;
                //        //vEDCamRootRot.x = Mathf.Clamp(vEDCamRootRot.x, -60.0f, 90.0f);
            ...
            else if (Input.GetMouseButton(0))
            {
                ...
                //if (SceneA)
                //{
                //    Vector3 movTempPos = this.transform.position;
                //    Vector3 movTempRot = this.transform.eulerAngles;
            ...
            else
            {
                ...
                if (pinchType == PinchType.Up)
                {
                    if (UseXRotation)
                    {
                        ...
                        vCamRootRot.x = Mathf.Clamp(vCamRootRot.x - fDelta, -30.0f, 90.0f);
